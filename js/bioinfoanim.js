...
$(document).ready(function () {
    ...
    $('#past').on("click", function () {
        ...
        $('#vehicle').css({
         ...
         $('#maintext').text("Oyez oyez ! Venez écouter les recommandations royales de notre souverain Théo de Silverberg. Un nouvel\n impôt sera prélevé à partir de la semaine prochaine et durant les six prochains mois afin de\n réparer les voies pavées romaines qui permettent le déplacement dans la cité. Les travaux forceront\n des changements de parcours. Pour rappels les voies centrales sont interdites aux charrettes seuls les corbillards funéraires et les processions de l'Eglise sont autorisés dans le coeur\n de la cité. Pour tout transport de marchandise dans la ville n'oubliez pas de le signaler aux\n Gardes de la Citadelle et de payez la Dîme.");
    });
